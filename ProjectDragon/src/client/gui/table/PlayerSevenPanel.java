...
public class PlayerSevenPanel extends JPanel implements IPlayerPanel {
	...
	private void init() {
		...
		p7c1Label.setIcon(new ImageIcon(path + "NORANKNOSUIT.gif"));
		this.add(p7c1Label);

		p7c2Label = new JLabel("Card 2\r\n");
		p7c2Label.setBounds(73, 5, 53, 80);
		p7c2Label.setIcon(new ImageIcon(path + "NORANKNOSUIT.gif"));
		this.add(p7c2Label);
	...
	public void showCards(IHand h) {
		...
		p7c1Label.setIcon(new ImageIcon(path + 
				card1.getRank() + card1.getSuit() + ".gif"));
		p7c2Label.setIcon(new ImageIcon(path + 
